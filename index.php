		...
		<div class="container">	
				...
				<div class="row" style="background-color: #BDBDBD">
					...
					<div class="col-md-2 mt-2">
		      		...
		      		<div class="w-50 h-25 mt-1 ">
		      			<a class="btn btn btn-info btn-sm " href="">Login</a>
		      		</div>		      				      		
		      		<div class="w-50 h-25 mt-3 ">
		      			<a class="btn btn btn-info btn-sm " href="">Cadastro</a>
		      		</div>
		      		</div>
				</div>
			</header>			
			...
			<nav>		
				...
				<div class="col-md-2"></div>
	    			...
	    			<a class="nav-link btn btn btn-dark btn-sm bg-info p-1" href="#">Início</a>
					</li>
